...
const (
	...
	// EndpointStateAllowLockdown captures enum value "allow-lockdown"
	EndpointStateAllowLockdown EndpointState = "allow-lockdown"
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["waiting-for-identity","not-ready","waiting-to-regenerate","regenerating","restoring","ready","disconnecting","disconnected","invalid","locking-down","allow-lockdown","full-lockdown"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
